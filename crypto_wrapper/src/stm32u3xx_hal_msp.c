/**
  ******************************************************************************
  * @file    MbedTLS_HW_KWE/Cipher_AES_CBC_EncryptDecrypt_KWE/Src/stm32u3xx_hal_msp.c
...
/* Global variables ----------------------------------------------------------*/
#if defined(HAL_CCB_MODULE_ENABLED)
extern CCB_HandleTypeDef hccb;
